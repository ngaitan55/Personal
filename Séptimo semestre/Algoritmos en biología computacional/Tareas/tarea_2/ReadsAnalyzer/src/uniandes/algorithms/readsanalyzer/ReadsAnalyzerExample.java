...
public class ReadsAnalyzerExample {
	...
	public static void main(String[] args) throws Exception {
		...
		if(COMMAND_OVERLAP.equals(command)) {
			...
			System.out.println(assembly.length() == 0 ? "The reads couldn't be assembled with an minimum overlap of " + minOverlap : assembly);
			...
			double mean = sum / (distribution.length - 1);
			System.out.println("The mean abundance is: " + mean);
		}
	}
	/**
